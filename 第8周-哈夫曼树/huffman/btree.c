...
bool btree_is_same(struct BTree *a, struct BTree *b) {
  ...
  return (a->data.ch == b->data.ch&&a->data.t==b->data.t) && btree_is_same(a->left, b->left) &&
...
bool btree_is_isomorphic(struct BTree *a, struct BTree *b) {
  ...
  return (a->data.ch == b->data.ch&&a->data.t == b->data.t) && ((btree_is_isomorphic(a->left, b->left) &&
